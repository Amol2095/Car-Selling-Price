...
import pickle
model = pickle.load(open('RandomForest_price_predict_model.pkl','rb'))

def main():
    string = "Car Selling Price Predictor"
    st.set_page_config(page_title=string, page_icon="🚗") 
    st.title("Car Price Predictor 🚗")
    st.markdown("##### Are you planning to sell your car !?\n##### So let's try evaluating the price.. 🤖 ")
    st.image(
            "https://i0.wp.com/sreditingzone.com/wp-content/uploads/2018/02/pexels-mike-205740-1-scaled.jpg?zoom=2&resize=780%2C470&ssl=1",
